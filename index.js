...
document.addEventListener('DOMContentLoaded', function() {
  ...
  paragraph.style.fontSize = '16px';
  paragraph.style.marginBottom = '20px';
  paragraph.innerHTML = 'YouTube (owned by Google) requires cookies to be enabled. Please open <a href="#" id="cookie-link" style="color: #ffff; text-decoration: underline;">Cookie Preferences</a> and enable <bold>Functional cookies</bold> to view the video.';
  overlayDiv.appendChild(paragraph);
